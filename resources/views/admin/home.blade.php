@extends('htmlStructure.main')

@section('content')
<!--inicio modulo FICHA LABORAL GENERAL -->
<!--inicio header FICHA LABORAL GENERAL -->
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Ficha Laboral General LOGO</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">ANEXO N° 3
                        </a></li>
                    <li class="breadcrumb-item active">Ficha Laboral General</li>
                </ol>
            </div>
        </div>

        <!--fin header FICHA LABORAL GENERAL -->
        <!-- SELECT2 EXAMPLE -->
        <section class="content">
            <div class="container-fluid">
                <div class="card card-blue">
                    <div class="card-header">
                        <h3 class="card-title">Ficha Laboral General</h3>

                        <div class="card-tools">
                            <i class="far fa-calendar-alt"></i> <label class="espacio-derecho-40"> {{ date('d-m-Y') }} </label>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4" style="width: 100%; ">
                                        <option selected="selected">Viña del mar</option>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" name="r1" checked id="radioSuccess2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="name" class="form-control" id="exampleInputName" placeholder="Nombres">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" data-inputmask="'mask': ['999-999-9999 [x99999]']" data-mask>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="correo@correo.cl">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="exampleInputName">AFP</label>
                                    <input type="name" class="form-control" id="exampleInputName" placeholder="AFP">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="exampleInputName">Nombre isapre</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                ...
                                <label>Cédula nacional de identidad</label>
                                <div class="input-group">
                                    <div class="row">
                                        <div class="col-xs-1" class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-id-card"></i></span>
                                        </div>
                                    </div>
                                    <input class="col-xs-8" name="txtRut" type="number" placeholder="12345678" class="form-control">
                                    <label class="col-xs-1"> &nbsp;-&nbsp; </label>
                                    <input class="col-xs-1" name="txtDv" style="width:30px;" type="text" placeholder="0" class="form-control">
                                </div>
                                <!-- /.input group -->
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="exampleInputName">Dirección particular</label>
                                    <input type="name" class="form-control" id="exampleInputName" placeholder="Dirección">
                                </div>
                            </div>
                        </div>
                        <!-- Fin row 3 -->
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control">
                                        ...
                                        <option>Visa de reunificación familiar</option>
                                        <option>Visa de estudiante residente para extranjeros</option>
                                        <option>Visa sujeta a contrato de trabajo para extranjeros</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-3">
                        ...
                        {{--<<<<Acá está el segmento verde--}}
                        <div class="card card-gray-dark">
                            <div class="card-header">
                                <h3 class="card-title">Nivel educacional</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <!-- checkbox -->
                                                <div class="form-group clearfix">
                                                    <div class="espacio-derecho-10 icheck-success d-inline ">
                                                        <input type="radio" id="nvlEducacion1" name="chk_nvl_educacion" checked>
                                                        <label for="nvlEducacion1">
                                                            Básico
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group clearfix">
                                                    <div class="espacio-derecho-10 icheck-success d-inline">
                                                        <input type="radio" id="nvlEducacion2" name="chk_nvl_educacion">
                                                        <label for="nvlEducacion2">
                                                            Medio
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="row">
                                                    <div class="espacio-derecho-10 col-xs-12 icheck-success d-inline">
                                                        <input type="radio" id="prgs_educacion4" name="chk_prgs_educacion">
                                                        <label for="prgs_educacion4">
                                                            Otro
                                                        </label>
                                                    </div>
                                                    <div class="espacio-derecho-10 col-xs-8 col-sm-6">
                                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group clearfix">
                                                    <div class="espacio-derecho-10 col-xs-12 icheck-success d-inline">
                                                        <input type="radio" id="prgs_educacion1" name="chk_prgs_educacion" checked>
                                                        <label for="prgs_educacion1">
                                                            Estudiante
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group clearfix">
                                                    ...
                                                    <div class="espacio-derecho-10 col-xs-12 icheck-success d-inline">
                                                        <input type="radio" id="prgs_educacion2" name="chk_prgs_educacion">
                                                        <label for="prgs_educacion2">
                                                            Egresado
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group clearfix">
                                                    ...
                                                    <div class="espacio-derecho-10 col-xs-12 icheck-success d-inline">
                                                        <input type="radio" id="prgs_educacion3" name="chk_prgs_educacion">
                                                        <label for="prgs_educacion3">
                                                            Titulado
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="espacio-derecho-10  col-sm-8">
                                                <div class="form-group">
                                                    <input type="name" class="form-control" id="exampleInputName">
                                                </div>
                                            </div>
        ...
        <!--FIN modulo FICHA LABORAL GENERAL -->
